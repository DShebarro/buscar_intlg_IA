      ...
      if (candidate && candidate.content?.parts?.[0]?.text) {
        ...
        if (sources.length > 0) {
          sources.forEach((source) => {
            ...
            el.className =
              "block p-3 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors truncate";
            el.innerHTML = `
          ...
          aiSources.innerHTML =
            '<p class="text-gray-400">Nenhuma fonte específica encontrada.</p>';
        }
